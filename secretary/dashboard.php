...
<div style="display: grid; grid-template-columns: 1fr 320px; gap: 24px;">
    ...
    <div class="right-col">
        ...
        <div class="card" style="margin-top: 24px;">
            <h3 style="margin-bottom: 16px;">Queue Monitor</h3>
            <p style="font-size: 13px; color: var(--text-secondary);">Current active queue for today's OPD consultations.</p>
            <button class="btn btn-outline btn-sm" style="width: 100%; margin-top: 10px;" onclick="window.location.href='<?= base_url('/public/secretary/queues.php') ?>'">Open Queue Manager</button>
        </div>
    </div>
</div>
<?php
