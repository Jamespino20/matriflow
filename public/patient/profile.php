        ...
        <div style="position: sticky; top: 24px;">
            <div class="card" style="text-align: center; padding: 32px 24px;">
                ...
                <div style="margin-top: 24px; text-align: left; background: var(--bg-light); padding: 16px; border-radius: 12px;">
                    <label style="font-size: 10px; opacity: 0.6; display: block; margin-bottom: 4px;">Member Since</label>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <form id="profile-form" action="<?= base_url('/public/controllers/profile-handler.php') ?>" method="POST" class="card" style="padding: 32px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="last_name" value="<?= htmlspecialchars((string)($u['last_name'] ?? '')) ?>" placeholder="Last Name">
                        <small style="display:block; font-size:10px; color:var(--text-secondary); margin-top:4px;">Update for marriage/annulment</small>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="occupation" value="<?= htmlspecialchars((string)($u['occupation'] ?? '')) ?>" placeholder="e.g. Teacher, Engineer">
                    </div>
                    <div class="form-group">
                ...
                <div style="margin-top: 32px; border-top: 1px solid var(--border-light); padding-top: 24px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" id="pat_p_curr" name="password_current" placeholder="Required for password changes" style="padding-right:40px;">
                            <button type="button" class="toggle" data-password-toggle data-target="pat_p_curr">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="pat_p_new" name="password_new" placeholder="Min 8 characters" style="padding-right:40px;">
                                <button type="button" class="toggle" data-password-toggle data-target="pat_p_new">
                                    <img src="<?= base_url('/public/assets/images/password-show.svg') ?>" alt="Show">
                                </button>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="pat_p_confirm" name="password_confirm" placeholder="Repeat new password" style="padding-right:40px;">
                                <button type="button" class="toggle" data-password-toggle data-target="pat_p_confirm">
                                    <img src="<?= base_url('/public/assets/images/password-show.svg') ?>" alt="Show">
                                </button>
                            </div>
                        </div>
            ...
            <div class="card" style="padding: 32px;">
                ...
                <div style="margin-top: 24px; display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <button type="button" onclick="confirmDelete()" class="btn btn-danger" style="width: 100%; justify-content: flex-start; gap: 12px; background: rgba(239, 68, 68, 0.1); color: var(--error); border: 1px solid var(--error);">
                        <span class="material-symbols-outlined">delete_forever</span> Deactivate Account
                    </button>
                </div>
            </div>
...
<script>
    function confirmDelete() {
        const confirmStr = prompt('Are you sure you want to deactivate your account? Type "DELETE" to confirm.');
        if (confirmStr === 'DELETE') {
            const fd = new FormData();
            fd.append('action', 'delete_account');
            fd.append('confirm_delete', 'DELETE');
            fd.append('csrf_token', '<?= CSRF::token() ?>');

            fetch('<?= base_url('/public/controllers/profile-handler.php') ?>', {
                method: 'POST',
                body: fd
...
RoleLayout::render($u, 'patient', 'profile', [
    'title' => 'My Profile',
    'content' => $content,
]);
