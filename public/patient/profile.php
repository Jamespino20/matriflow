        ...
        <div style="position: sticky; top: 24px;">
            <div class="card" style="text-align: center; padding: 32px 24px;">
                <div style="position: relative; display: inline-block; margin-bottom: 16px;">
                    <img src="<?= base_url('/public/assets/images/avatars/' . (int)$u['user_id'] . '.png?t=' . time()) ?>"
                        alt="Avatar"
            ...
            <form id="profile-form" action="<?= base_url('/public/controllers/profile-handler.php') ?>" method="POST" class="card" style="padding: 32px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="emergency_contact_phone" value="<?= htmlspecialchars((string)($u['emergency_contact_phone'] ?? '')) ?>" placeholder="+63 9xx xxx xxxx">
                    </div>
                </div>
                ...
                <div style="margin-top: 32px; border-top: 1px solid var(--border-light); padding-top: 24px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_current" placeholder="Required for password changes">
                    </div>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            <label>New Password</label>
                            <input type="password" name="password_new" placeholder="Min 8 characters">
                        </div>
                        <div class="form-group">
