...
<div class="card no-print">
    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:24px;">
        <div>
            <h2 style="margin:0">System-Wide Reports</h2>
            <p style="margin:5px 0 0; font-size:14px; color:var(--text-secondary)">Consolidated clinic metrics and operational audits.</p>
        </div>
    </div>
        ...
        <div class="filter-row">
            <div class="form-group" style="flex: 2; position:relative;">
                ...
                <div id="type-dropdown" class="dropdown-content">
                    ...
                    <label><input type="checkbox" name="type[]" value="financial_summary" onchange="updateFiltersDisplay()"> Financial Summary Snapshot</label>
                    ...
                    <label><input type="checkbox" name="type[]" value="audit" onchange="updateFiltersDisplay()"> System Audit Logs</label>
                </div>
            </div>
            ...
            <div class="form-group" style="position:relative;">
                ...
                <div id="patient-dropdown" class="dropdown-content">
                    ...
                    <div id="patient-list-container">
                        <!-- Recently active or search results here -->
...
<script>
    ...
    function updateFiltersDisplay() {
        ...
        // Doctors
        updateSingleDropdown('doctor-dropdown', 'doctor-select-display', 'All Doctors');
        // Patients
    ...
    function exportToCSV() {
        ...
        link.download = `MatriFlow_System_Report_${new Date().toISOString().split('T')[0]}.csv`;
        link.click();
    }
</script>
<?php
