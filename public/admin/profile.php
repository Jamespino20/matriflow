        ...
        <div style="position: sticky; top: 24px;">
            <div class="card" style="text-align: center; padding: 32px 24px;">
                ...
                <div style="margin-top: 24px; text-align: left; background: var(--bg-light); padding: 16px; border-radius: 12px;">
                    <label style="font-size: 10px; opacity: 0.6; display: block; margin-bottom: 4px;">System Admin Since</label>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <form id="profile-form" action="<?= base_url('/public/controllers/profile-handler.php') ?>" method="POST" class="card" style="padding: 32px;">
                ...
                <h3 style="margin-bottom: 24px; border-bottom: 1px solid var(--border-light); padding-bottom: 12px; display: flex; align-items: center; gap: 8px;">
                    <span class="material-symbols-outlined">person</span> Administrator Details
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div class="form-group">
                        <label>Occupation / System Role</label>
                        <input type="text" name="occupation" value="<?= htmlspecialchars((string)($u['occupation'] ?? '')) ?>" placeholder="e.g. IT Administrator">
                    </div>
                    <div class="form-group">
                ...
                <div style="margin-top: 32px; border-top: 1px solid var(--border-light); padding-top: 24px;">
                    <h3 style="margin-bottom: 24px; display: flex; align-items: center; gap: 8px;">
                        <span class="material-symbols-outlined">security</span> Master Security
                    </h3>

                    <div class="form-group">
                        <label>Current Master Password</label>
                        <div class="input-group">
                            <input type="password" id="p_current" name="password_current" placeholder="Required for security changes" style="padding-right:40px;">
                            <button type="button" class="toggle" data-password-toggle data-target="p_current">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="p_new" name="password_new" placeholder="Min 12 characters recommended" style="padding-right:40px;">
                                <button type="button" class="toggle" data-password-toggle data-target="p_new">
                                    <img src="<?= base_url('/public/assets/images/password-show.svg') ?>" alt="Show">
                                </button>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="p_confirm" name="password_confirm" placeholder="Repeat new password" style="padding-right:40px;">
                                <button type="button" class="toggle" data-password-toggle data-target="p_confirm">
                                    <img src="<?= base_url('/public/assets/images/password-show.svg') ?>" alt="Show">
                                </button>
                            </div>
                        </div>
            ...
            <div class="card" style="padding: 32px;">
                <h3 style="margin-bottom: 24px; display: flex; align-items: center; gap: 8px;">
                    <span class="material-symbols-outlined">settings</span> Preferences & System Actions
                </h3>
                ...
                <div style="margin-top: 24px; display: flex; flex-direction: column; gap: 12px;">
                    <form action="<?= base_url('/public/controllers/profile-handler.php') ?>" method="POST" style="display:inline;">
                        ...
                        <button type="submit" class="btn btn-secondary" style="width: 100%; justify-content: flex-start; gap: 12px;">
                            <span class="material-symbols-outlined">download</span> Download Full System Backup (Audit)
                        </button>
                    </form>
                </div>
            </div>
...
RoleLayout::render($u, 'admin', 'profile', [
