...
<?php else: ?>
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <div style="display: flex; align-items: center; gap: 16px;">
            <a href="<?= base_url('/public/doctor/records.php') ?>" class="btn btn-icon" title="Go Back"><span class="material-symbols-outlined">arrow_back</span></a>
            <div>
        ...
        <div class="side-info">
            ...
            <div class="card" style="margin-top: 24px;">
                ...
                <?php if (!$baseline): ?>
                    ...
                    <button class="btn btn-primary" style="width: 100%;" onclick="document.getElementById('modal-new-baseline').style.display='flex'">Start New Baseline</button>
                <?php else: ?>
            ...
            <div class="card">
                ...
                <div id="tab-prenatal" class="tab-pane active">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <?php if ($baseline): ?>
                            <button class="btn btn-primary btn-sm" onclick="document.getElementById('modal-add-visit').style.display='flex'"><span class="material-symbols-outlined">add</span> New Entry</button>
                        <?php endif; ?>
                    </div>
                    <table class="table">
                        <thead>
                ...
                <div id="tab-consultations" class="tab-pane">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <button class="btn btn-primary btn-sm" onclick="document.getElementById('modal-add-consult').style.display='flex'"><span class="material-symbols-outlined">add</span> New Consultation</button>
                    </div>
                    <?php
                    // Filter for general
                ...
                <div id="tab-prescriptions" class="tab-pane">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <button class="btn btn-primary btn-sm" onclick="document.getElementById('modal-add-prescription').style.display='flex'"><span class="material-symbols-outlined">description</span> Issue New</button>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
...
<div id="modal-new-baseline" class="modal-overlay modal-clean-center" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:10000; background:rgba(0,0,0,0.5); align-items:center; justify-content:center;">
    <div class="modal-card" style="background:var(--surface); width:90%; max-width:500px; border-radius:12px; padding:32px; position:relative;">
        <button type="button" class="modal-close" style="position:absolute; top:16px; right:16px;" onclick="document.getElementById('modal-new-baseline').style.display='none'">&times;</button>
...
<div id="modal-add-consult" class="modal-overlay modal-clean-center" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:10000; background:rgba(0,0,0,0.5); align-items:center; justify-content:center;">
    <div class="modal-card" style="background:var(--surface); width:90%; max-width:600px; border-radius:12px; padding:32px; position:relative;">
        <button type="button" class="modal-close" style="position:absolute; top:16px; right:16px;" onclick="document.getElementById('modal-add-consult').style.display='none'">&times;</button>
...
<div id="modal-add-prescription" class="modal-overlay modal-clean-center" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:10000; background:rgba(0,0,0,0.5); align-items:center; justify-content:center;">
    <div class="modal-card" style="background:var(--surface); width:90%; max-width:500px; border-radius:12px; padding:32px; position:relative;">
        <button type="button" class="modal-close" style="position:absolute; top:16px; right:16px;" onclick="document.getElementById('modal-add-prescription').style.display='none'">&times;</button>
        ...
        <form action="<?= base_url('/public/controllers/clinical-handler.php') ?>" method="POST" style="margin-top: 20px;">
            ...
            <div class="form-group"><label>Medication Name</label><input type="text" name="medication_name" required placeholder="e.g. Paracetamol"></div>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
...
<script>
    ...
    function openConsultModal(type) {
        ...
        document.getElementById('modal-add-consult').style.display = 'flex';
    }
</script>
<?php
