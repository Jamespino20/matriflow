...
<div class="profile-container" style="max-width: 900px; margin: 0 auto;">
    ...
    <div style="display: grid; grid-template-columns: 280px 1fr; gap: 32px; align-items: start;">
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <form id="profile-form" action="/public/controllers/profile-handler.php" method="POST" class="card" style="padding: 32px;">
            ...
            <div class="card" style="padding: 32px;">
                ...
                <div style="margin-top: 24px; display: flex; flex-direction: column; gap: 12px;">
                    <form action="/public/controllers/profile-handler.php" method="POST" style="display:inline;">
                        <?= CSRF::input() ?>
