            ...
            <form id="profile-form" action="<?= base_url('/public/controllers/profile-handler.php') ?>" method="POST" class="card" style="padding: 32px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="occupation" value="<?= htmlspecialchars((string)($u['occupation'] ?? '')) ?>" placeholder="e.g. Medical Secretary">
                    </div>
                    <div class="form-group">
                ...
                <div style="margin-top: 32px; border-top: 1px solid var(--border-light); padding-top: 24px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" id="sec_p_curr" name="password_current" placeholder="Required for password changes" style="padding-right:40px;">
                            <button type="button" class="toggle" data-password-toggle data-target="sec_p_curr">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="sec_p_new" name="password_new" placeholder="Min 8 characters" style="padding-right:40px;">
                                <button type="button" class="toggle" data-password-toggle data-target="sec_p_new">
                                    <img src="<?= base_url('/public/assets/images/password-show.svg') ?>" alt="Show">
                                </button>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="sec_p_confirm" name="password_confirm" placeholder="Repeat new password" style="padding-right:40px;">
                                <button type="button" class="toggle" data-password-toggle data-target="sec_p_confirm">
                                    <img src="<?= base_url('/public/assets/images/password-show.svg') ?>" alt="Show">
                                </button>
                            </div>
                        </div>
...
RoleLayout::render($u, 'secretary', 'profile', [
    'title' => 'My Profile',
    'content' => $content,
]);
