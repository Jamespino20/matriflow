...
<?php else: ?>
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <div style="display: flex; align-items: center; gap: 16px;">
            <a href="<?= base_url('/public/secretary/patients.php') ?>" class="btn btn-icon" title="Go Back"><span class="material-symbols-outlined">arrow_back</span></a>
            <div>
        ...
        <div style="display: flex; gap: 12px;">
            <a href="<?= base_url('/public/shared/messages.php?start_chat=' . $patientId) ?>" class="btn btn-outline" style="display:flex; align-items:center; gap:8px;"><span class="material-symbols-outlined">chat</span> Message</a>
                ...
                <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 15px;">
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <span style="font-weight: 600;">
                            <?= ($latest && $latest['systolic_pressure'] && $latest['diastolic_pressure']) ? $latest['systolic_pressure'] . '/' . $latest['diastolic_pressure'] . ' mmHg' : '--' ?>
                        </span>
                    </div>
                    <div style="display: flex; justify-content: space-between;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <span style="font-weight: 600;"><?= ($latest && $latest['heart_rate']) ? $latest['heart_rate'] . ' bpm' : '--' ?></span>
                    </div>
                </div>
            </div>
                ...
                <div id="tab-prenatal" class="tab-pane active">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <div style="display:flex; gap:8px;">
                            <button class="btn btn-outline btn-sm" onclick="document.getElementById('modal-vitals').classList.add('show')"><span class="material-symbols-outlined">vital_signs</span> Record Vitals</button>
                            <?php if ($baseline): ?>
...
<div id="modal-vitals" class="modal-overlay modal-clean-center">
    <div class="modal-card" style="background:var(--surface); width:90%; max-width:500px; border-radius:12px; padding:32px; position:relative;">
        <button type="button" class="modal-close" style="position:absolute; top:16px; right:16px;" onclick="document.getElementById('modal-vitals').classList.remove('show')">&times;</button>
        ...
        <form action="<?= base_url('/public/controllers/prenatal-handler.php') ?>" method="POST" style="margin-top: 20px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                <div class="form-group"><label>Systolic BP</label><input type="number" name="systolic" placeholder="e.g. 120" required></div>
                <div class="form-group"><label>Diastolic BP</label><input type="number" name="diastolic" placeholder="e.g. 80" required></div>
            </div>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                <div class="form-group"><label>Heart Rate (bpm)</label><input type="number" name="heart_rate" placeholder="72"></div>
                <div class="form-group"><label>Weight (kg)</label><input type="number" step="0.1" name="weight" placeholder="60.5"></div>
            </div>
            <div class="form-group"><label>Temp (°C)</label><input type="number" step="0.1" name="temp" placeholder="36.5"></div>
            ...
            <div class="form-group">
                ...
                <div class="custom-multiselect" id="meds-multiselect">
                    ...
                    <div class="checkboxes-wrapper" id="meds-options">
                        <?php
                        $commonMeds = ['Folic Acid', 'Ferrous Sulfate', 'Calcium Carbonate', 'Multivitamins + Iron', 'Paracetamol', 'Mefenamic Acid', 'Tranexamic Acid', 'Isoxsuprine', 'Dydrogesterone (Duphaston)', 'Metformin', 'Aspirin (Low-dose)', 'Methyldopa'];
...
<script>
    ...
    <?php if (isset($_GET['success'])): ?>
        window.onload = function() {
            ...
            if (urlParams.get('success') === 'consult') switchTab('consultations');
            if (urlParams.get('success') === 'presc') switchTab('prescriptions');
        }
    <?php endif; ?>
</script>
<?php
